...
PROJECT = {
  "code": "P19",
  "slug": "digital-transformation-timeline",
  ...
  "kind": "timeline",
  "dataset": "Editable timeline CSV sample",
  "source": "Local editable sample",
  "description": "Timeline visualization lab for milestones in digital transformation from an editable CSV.",
  "concepts": [
    "broken_barh",
    "annotations",
